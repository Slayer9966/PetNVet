    ...
    public function update(Request $request)
{
    ...
    // Check if the 'unique' provided matches the currently authenticated user's 'Unique_Password'
    if ($request->unique != auth()->user()->Unique_Password) {
    ...
    $user->Unique_Password = $request->input('uniquep'); // Assuming 'Unique_Password' is a field in your user model
